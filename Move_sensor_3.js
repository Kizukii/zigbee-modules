...
const device = {
    zigbeeModel: ['Move_sensor_3'],
    model: 'Move_sensor_3',
    vendor: 'User.sensor',
    description: '[Configurable firmware](https://ptvo.info/zigbee-configurable-firmware-features/)',
    fromZigbee: [fz.ignore_basic_report, fz.ptvo_on_off, fz.ptvo_switch_analog_input, fz.ptvo_multistate_action, fz.legacy.ptvo_switch_buttons, fz.ptvo_on_off_config,],
    toZigbee: [tz.ptvo_switch_trigger, tz.on_off, tz.ptvo_switch_analog_input, tz.ptvo_on_off_config,],
    exposes: [e.gas().withEndpoint('l2'),
